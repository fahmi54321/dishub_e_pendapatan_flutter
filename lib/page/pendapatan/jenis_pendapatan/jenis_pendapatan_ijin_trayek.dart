...
class JenisPendapatanIjinTrayek extends StatelessWidget {
...
class ListJenisPendapatanDetails extends StatefulWidget {
  ...
  @override
  State<ListJenisPendapatanDetails> createState() => _ListJenisPendapatanDetailsState();
}

class _ListJenisPendapatanDetailsState extends State<ListJenisPendapatanDetails> {
...
class RincianIjinTrayek extends StatelessWidget {
  const RincianIjinTrayek({
    Key? key,
  }) : super(key: key);
